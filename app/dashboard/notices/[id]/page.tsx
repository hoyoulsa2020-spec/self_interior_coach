...
export default function DashboardNoticeDetailPage() {
  ...
  if (!notice) {
    return (
      <div className="space-y-4">
        ...
        <Link href="/dashboard/notices" className="text-sm font-medium text-indigo-600 hover:underline">
          목록으로
        </Link>
      </div>
    );
